      ...
      <div className="py-12 space-y-24">
        <section className="text-center px-[6%] md:px-[14%]">
          ...
          >
            ...
            nosso empenho em atuar com integridade e em total conformidade com
            as melhores práticas de gestão associativa. Ao consultá-lo, você
            terá uma visão completa de como a Socinpro opera para defender seus
            interesses
          </p>
          <Button
            size="lg"
