...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-coal-900 px-4 py-2 uppercase text-white text-sm font-normal transition-colors duration-200 hover:bg-teal/60 hover:text-white focus:bg-teal focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-teal/50 data-[state=open]:bg-teal/50"
);
