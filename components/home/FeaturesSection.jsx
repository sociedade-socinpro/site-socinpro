  ...
  return (
    <>
      ...
      <div className="relative flex justify-center items-center px-[6%] md:px-[14%] py-16">
        <div className="w-full h-full z-0 absolute bg-coal-900 bg-[url('/images/music_fans.png')] bg-cover hover:transform hover:scale-[101%] transition-transform opacity-0 animate-fade-in" />
        <InfoCard
