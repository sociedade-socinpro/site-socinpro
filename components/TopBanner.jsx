...
export function TopBanner() {
  return (
    <div className="hidden lg:block px-[6%] xl:px-[14%] py-2 bg-teal">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-2 lg:gap-4 2xl:max-w-[1920px] mx-auto text-white text-center text-[10px] sm:text-xs">
